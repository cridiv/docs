---
title: "Vouch SDK Escrow: Create and Manage Payment Agreements"
sidebarTitle: "Escrow"
description: "Create milestone-based escrow agreements, run fraud checks before payment, confirm deliverables, and track agreement status through the full lifecycle."
---
...
console.log('Virtual account:', agreement.virtualAccountNo);
```
...
<ResponseField name="virtualAccountId" type="string | null">
  A virtual account identifier assigned to this agreement. May be `null` until the agreement is ready to receive funds.
</ResponseField>
