---
title: "Authentication — API Keys and Request Security"
sidebarTitle: "Authentication"
description: "Learn how Vouch API keys work, how to generate them, and how to keep them secure in both server-side and client-side environments."
---
...
Store your API key and optional URL override as environment variables rather than hard-coded strings. The SDK reads these two variables by convention:

| Variable | Purpose | Example value |
|---|---|---|
| `VOUCH_API_KEY` | Your API key | `vouch_live_8f9a2b3c...` |
| `VOUCH_API_URL` | Override the default base URL | `https://staging.example.com/v1` |

`VOUCH_API_URL` defaults to `https://vouch-fmql.onrender.com/v1` when not set. Override it to point at a local proxy, a staging environment, or a self-hosted Vouch instance.
